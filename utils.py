...
'Pierwszego dnia wiosny kwiaty otworzyły swoje płatki z nadzieją. (희망) 봄의 첫날, 꽃들이 희망에 가득 차 꽃잎을 활짝 피웠다.',
        ...
        script=[
'"Что это за шум?" спросила девочка с тревогой. (호기심) "저 소리가 뭐지?" 소녀가 걱정스럽게 물었다',
'"Ура! Первый снег выпал!" закричал мальчик радостно. (기쁨) "우와! 첫눈이 왔어!" 소년이 기쁘게 외쳤다.',
'"Не наступай туда, это опасно," сказала мама строго. (걱정) "거기 발 디디지 마, 위험해," 엄마가 단호히 말했다.',
'"Я больше сюда не вернусь," сказал человек грустно. (슬픔) "나는 여기로 다시 돌아오지 않을 거야," 남자가 슬프게 말했다.',
'"Беги! Он идёт за нами!" крикнула женщина испуганно. (두려움) "도망쳐! 그가 우리를 따라오고 있어!" 여자가 겁에 질려 외쳤다.',
'Листья падали, как перья в воздухе. (평온함) 잎들이 공기 속에서 깃털처럼 떨어졌다.',
'Ночь была тихой, лишь звёзды мерцали. (신비로움) 밤은 고요했고, 별들만 반짝이고 있었다.',
'Дождь стучал по крыше, словно шёпот. (따뜻함) 비가 지붕을 두드리며 마치 속삭이는 듯했다.',
'Ветер свистел между деревьями, вызывая дрожь. (긴장감) 바람이 나무들 사이로 휘파람 소리를 내며 몸을 떨게 했다.',
'С рассветом солнце согревало холодную землю. (희망) 새벽이 되자 태양이 차가운 땅을 따뜻하게 만들었다.',
        ]
